...
## https://www.biodiversityresearchlab.com
## Virginia Commonwealth University
##
## Academic Diversity Disparity Map
##
## The following code uses data from the National Center for Education Statistics to create a map demonstrating the disparity between percent minority students and percent minority faculty across universities and colleges in the United States
...
#### Sandbox: Disparity Map - Hispanic/Latinx ####
